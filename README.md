...
- [iTunes Search API](https://developer.apple.com/library/archive/documentation/AudioVideo/Conceptual/iTuneSearchAPI/) — no API key required
...
- Deploy to Vercel for a live demo link
- Persist a "recently played" list
